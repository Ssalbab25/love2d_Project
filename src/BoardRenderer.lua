...
function BoardRenderer:draw(board, selectedPos, validMoves, isGameOver, winner, pendingPromotion, whiteTime, blackTime,
                            currentTurn, capturedPieces, pendingDrawOffer, gameOverReason, screenState, gameMode,
                            aiDifficulty)
    -- 화면 중앙 배치 갱신 (반응형 대응)
